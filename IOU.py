...
def intersection_over_union(box_values, actual_box):
  ...
  box1_area = abs((box_values[...,2:3] - box_values[...,0:1]) * (box_values[...,3:4] - box_values[...,1:2]))
  box2_area = abs((actual_box[...,2:3] - actual_box[...,0:1]) * (actual_box[...,3:4] - actual_box[...,1:2]))

  return  inter_box_area / (box1_area + box2_area - inter_box_area)
